...
class PyTorchBaseRunner(metaclass=abc.ABCMeta):
    ...
    def train_epoch(
        ...
        self._loss_saver._writer = self._writer
    ...
    def _save_stream(self, data_loader, mode: str):
        ...
        if cm.use_cs():
            from cerebras.framework.torch.utils.data.dataloader import (
                DataLoader,
            )
            ...
            data_loader = data_loader._loader
    ...
    def create(
        ...
        compile_only = runconfig_params["compile_only"]
